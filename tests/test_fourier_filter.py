...
class TestFourierFilterBase(unittest.TestCase):
    ...
    def g_using_F(self):
        ...
        assert_allclose(gr[first:last], self.gofr_ff_target, rtol=self.rtol, atol=self.atol)
    ...
    def GK_using_F(self):
        ...
        first, last = self.real_space_first, self.real_space_last
        assert_allclose(gr[first:last], self.GKofR_ff_target, rtol=self.rtol, atol=self.atol)
